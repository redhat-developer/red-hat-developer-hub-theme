# Customizing the look of your RHDH instance

To customize the look of your RHDH instance, you can edit the `app-config.yaml` file in the root of this repository. The customizations used to configure the app are loaded by the backstage app at startup, with certain values being queried by the app at runtime.
...
![Default Icon Logo when side bar is collapsed](docs/images/default-collapsed-icon.png)
![Default Full Logo when side bar is expanded](docs/images/default-expanded-logo.png)
...
![Custom Title and Favicon](docs/images/custom-title-and-favicon.png)
...
![Example Light Mode Primary Color](docs/images/example-light-mode-primary-color.png)
![Example Dark Mode Primary Color](docs/images/example-dark-mode-primary-color.png)
...
![Example Light Mode Banner](docs/images/example-light-mode-banner.png)
![Example Dark Mode Banner](docs/images/example-dark-mode-banner.png)
...
![Example Light Mode Sidebar Indicator](docs/images/example-sidebar-indicator-light.png)
![Example Dark Mode Sidebar Indicator](docs/images/example-sidebar-indicator-dark.png)
